    ...
    <>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          ...
          <CategoryEditForm category={category} onSuccess={handleEditSuccess} />
        </DialogContent>
      </Dialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              category "{category.name}". Menu items in this category will not be deleted but will need to be re-categorized.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
